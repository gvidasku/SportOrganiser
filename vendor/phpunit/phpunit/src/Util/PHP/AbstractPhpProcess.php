...
abstract class AbstractPhpProcess
{
    ...
    /**
     * Sets the string of arguments to pass to the php sportevent.
     */
    ...
    /**
     * Returns the string of arguments to pass to the php sportevent.
     */
     ...
     */
    public function runTestsportevent(string $sportevent, Test $test, TestResult $result): void
    {
        $result->startTest($test);

        $_result = $this->runsportevent($sportevent);
     ...
     */
    abstract public function runsportevent(string $sportevent, array $settings = []): array;
