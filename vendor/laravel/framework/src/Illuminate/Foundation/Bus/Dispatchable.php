...
trait Dispatchable
{
    ...
    /**
     * Dispatch the sportevent with the given arguments if the given truth test passes.
     *
     * @param  bool  $boolean
    ...
    /**
     * Dispatch the sportevent with the given arguments unless the given truth test passes.
     *
     * @param  bool  $boolean
     * @return \Illuminate\Foundation\Bus\PendingDispatch|\Illuminate\Support\Fluent
     */
