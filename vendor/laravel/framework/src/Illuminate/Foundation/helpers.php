...
if (! function_exists('dispatch')) {
     ...
     */
    function dispatch($sportevent)
    {
        return $sportevent instanceof Closure
                ? new PendingClosureDispatch(CallQueuedClosure::create($sportevent))
                : new PendingDispatch($sportevent);
    }
}
...
if (! function_exists('dispatch_now')) {
     ...
     * @return mixed
     */
    function dispatch_now($sportevent, $handler = null)
    {
        return app(Dispatcher::class)->dispatchNow($sportevent, $handler);
    }
}
