...
use Illuminate\Foundation\Console\sporteventMakeCommand;
...
class ArtisanServiceProvider extends ServiceProvider implements DeferrableProvider
{
    ...
    protected $devCommands = [
        ...
        'sporteventMake' => 'command.sportevent.make',
     ...
     * @return void
     */
    protected function registersporteventMakeCommand()
    {
        $this->app->singleton('command.sportevent.make', function ($app) {
            return new sporteventMakeCommand($app['files']);
        });
    }
