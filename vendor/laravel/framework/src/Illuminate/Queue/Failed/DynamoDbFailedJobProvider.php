...
class DynamoDbFailedsporteventProvider implements FailedsporteventProviderInterface
{
    /**
    ...
    {
        throw new Exception("DynamoDb failed sportevent storage may not be flushed. Please use DynamoDb's TTL features on your expires_at attribute.");
    }
}
