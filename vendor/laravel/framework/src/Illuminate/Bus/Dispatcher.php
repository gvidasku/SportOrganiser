...
class Dispatcher implements QueueingDispatcher
{
    ...
    public function dispatchNow($command, $handler = null)
    {
        ...
        if (in_array(InteractsWithQueue::class, $uses) &&
            ...
            ! $command->sportevent) {
            $command->setsportevent(new Syncsportevent($this->container, json_encode([]), 'sync', 'sync'));
        }
    ...
    {
        return new PendingBatch($this->container, Collection::wrap($sportevents));
    }
    ...
    public function chain($sportevents)
    {
        ...
        return new PendingChain($sportevents->shift(), $sportevents->toArray());
    }
