...
class PendingBatch
{
    ...
    /**
     * The sportevents that belong to the batch.
     *
     ...
     * @param  \Illuminate\Support\Collection  $sportevents
     * @return void
     */
    public function __construct(Container $container, Collection $sportevents)
    {
    ...
    /**
     * Add a callback to be executed after all sportevents in the batch have executed successfully.
     *
    ...
    /**
     * Add a callback to be executed after the first failing sportevent in the batch.
     *
     * @param  callable  $callback
     * @return $this
     */
    ...
    /**
     * Indicate that the batch should not be cancelled when a sportevent within the batch fails.
     *
    ...
    /**
     * Determine if the pending batch allows sportevents to fail without cancelling the batch.
     *
     * @return bool
     */
    ...
    /**
     * Specify the queue connection that the batched sportevents should run on.
     *
    ...
    /**
     * Specify the queue that the batched sportevents should run on.
     *
     * @param  string  $queue
     * @return $this
     */
    ...
    public function dispatch()
    {
        ...
        try {
            ...
            $batch = $batch->add($this->sportevents);
        } catch (Throwable $e) {
            if (isset($batch)) {
