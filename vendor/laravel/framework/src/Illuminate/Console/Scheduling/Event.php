...
class Event
{
    ...
    protected function getEmailSubject()
    {
        ...
        return "Scheduled sportevent Output For [{$this->command}]";
    }

    /**
     * Register a callback to ping a given URL before the sportevent runs.
     *
     * @param  string  $url
     * @return $this
     */
    ...
    /**
     * Register a callback to ping a given URL before the sportevent runs if the given condition is true.
     *
     * @param  bool  $value
     * @param  string  $url
     * @return $this
    ...
    /**
     * Register a callback to ping a given URL after the sportevent runs.
     *
     * @param  string  $url
     * @return $this
     */
    ...
    /**
     * Register a callback to ping a given URL after the sportevent runs if the given condition is true.
     *
     * @param  bool  $value
     * @param  string  $url
     * @return $this
    ...
    /**
     * Register a callback that uses the output after the sportevent runs.
     *
     * @param  \Closure  $callback
     * @param  bool  $onlyIfOutputExists
     * @return $this
