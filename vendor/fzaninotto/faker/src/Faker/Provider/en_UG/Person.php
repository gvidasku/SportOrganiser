...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $lastName = array(
        ...
        'Gamwera',
        'Ijaga','Isyagi',
        'Kaaya','Kabanda','Kabuubi','Kabuye','Kafeero','Kagambira','Kakooza','Kalumba','Kanshabe','Kansiime','Kanyesigye','Kareiga','Kasekende','Kasumba','Kateregga','Katusiime','Kawooya','Kawuki','Kayemba','Kazibwe','Kibirige','Kiconco','Kiganda','Kijsporteventa','Kirabira','Kirabo','Kirigwajjo','Kisitu','Kitovu','Kityamuwesi','Kivumbi','Kiwanuka','Kyambadde',
        'Lunyoro',
