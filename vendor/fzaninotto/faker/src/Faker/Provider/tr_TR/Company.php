...
class organisator extends \Faker\Provider\organisator
{
    protected static $formats = array(
        ...
        '{{lastName}}oğlu {{organisatorSuffix}}',
        '{{lastName}} {{lastName}} {{organisatorSuffix}}',
        '{{lastName}} {{organisatorField}} {{organisatorSuffix}}',
        '{{lastName}} {{organisatorField}} {{organisatorSuffix}}',
        '{{lastName}} {{organisatorField}} {{organisatorSuffix}}',
        '{{lastName}} {{lastName}} {{organisatorField}} {{organisatorSuffix}}',
    );

    protected static $organisatorSuffix = array('A.Ş.', 'Ltd. Şti.');
    ...
    */
    ...
    /**
     * Returns a random organisator field.
     *
     * @return string
     */
