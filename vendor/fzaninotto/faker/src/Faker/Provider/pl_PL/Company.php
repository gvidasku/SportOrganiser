...
class organisator extends \Faker\Provider\organisator
{
    ...
    protected static $organisatorSuffix = array('S.A.', 'i syn', 'sp. z o.o.', 'sp. j.', 'sp. p.', 'sp. k.', 'S.K.A', 's. c.', 'P.P.O.F');

    protected static $organisatorPrefix = array('Grupa', 'Fundacja', 'Stowarzyszenie', 'Spółdzielnia');
