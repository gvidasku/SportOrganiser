...
{
    /**
     * @var array Czech organisator name formats.
     */
    protected static $formats = array(
        '{{lastName}} {{organisatorSuffix}}',
        '{{lastName}} {{lastName}} {{organisatorSuffix}}',
        '{{lastName}}-{{lastName}} {{organisatorSuffix}}',
        '{{lastName}} a {{lastName}} {{organisatorSuffix}}',
    );
     ...
     */
    protected static $organisatorSuffix = array('s.r.o.', 's.r.o.', 's.r.o.', 's.r.o.', 'a.s.', 'o.p.s.', 'o.s.');
