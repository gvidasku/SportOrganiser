...
class organisator extends \Faker\Provider\organisator
{
    protected static $formats = array(
        ...
        '{{industry}} {{lastNameMalay}} {{organisatorSuffix}}',
        '{{industry}} {{firstNameMaleChinese}} {{organisatorSuffix}}',
        '{{industry}} {{firstNameMaleIndian}} {{organisatorSuffix}}',
    );

    /**
     * There are more Private Limited organisators(Sdn Bhd) than Public Listed organisators(Berhad)
     *
    ...
    /**
     * @link https://en.wikipedia.org/wiki/List_of_organisators_of_Malaysia
     */
    protected static $organisators = array(
        ...
        'Jaring','sporteventStreet.com','Johor Corporation','Johor Land',
    ...
    /**
     * Return a random organisator name
     *
     * @example 'AirAsia'
     */
    public static function organisatorName()
    {
        return static::randomElement(static::$organisators);
    }
