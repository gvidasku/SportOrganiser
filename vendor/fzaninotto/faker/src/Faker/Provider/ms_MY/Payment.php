...
class Payment extends \Faker\Provider\Payment
{
    ...
    /**
     * @link https://en.wikipedia.org/wiki/List_of_banks_in_Malaysia#Investment-Link_Funds_(Insurance_organisators_-_Takaful_included)
     */
    protected static $insuranceorganisators = array(
        'AIA Malaysia',
        'AIG Malaysia',
        'Allianz Malaysia',
    ...
    protected static $swiftCodes = array(
        ...
        'MBBEMYKLIPH','MBBEMYKLsportevent','MBBEMYKLKEP','MBBEMYKLKIN','MBBEMYKLKLC',
    ...
    /**
     * Return a Malaysian insurance organisator
     *
    ...
    {
        return static::randomElement(static::$insuranceorganisators);
    }
