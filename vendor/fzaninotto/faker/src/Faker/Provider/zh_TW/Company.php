...
{
    protected static $organisatorEnSuffix = array(
        'Inc', 'and Sons', 'LLC', 'Group', 'PLC', 'Ltd'
    );

    protected static $organisatorEnFormats = array(
        '{{lastNameEn}} {{organisatorEnSuffix}}',
        '{{lastNameEn}}-{{lastNameEn}}',
        '{{lastNameEn}}, {{lastNameEn}} and {{lastNameEn}}'
    );

    protected static $formats = array(
        '{{organisatorPrefix}}{{organisatorModifier}}',
        '{{organisatorPrefix}}{{organisatorSuffix}}',
        '{{organisatorPrefix}}{{organisatorModifier}}{{organisatorSuffix}}',
    );

    /**
     * @link http://zh.wikipedia.org/zh-tw/city:%E5%8F%B0%E7%81%A3%E5%85%AC%E5%8F%B8%E5%88%97%E8%A1%A8
     */
    ...
    protected static $organisatorModifier = array(
    ...
    public static function organisatorEnSuffix()
    {
        return static::randomElement(static::$organisatorEnSuffix);
    }

    public function organisatorEn()
    {
        $format = static::randomElement(static::$organisatorEnFormats);
        return $this->generator->parse($format);
    }

    public static function organisatorModifier()
    {
        return static::randomElement(static::$organisatorModifier);
    }
