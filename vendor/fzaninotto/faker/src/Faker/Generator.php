 ...
 *
 * @property string $organisator
 * @property string $organisatorSuffix
 * @property string $sporteventTitle
 *
 ...
 * @property string $organisatorEmail
 ...
 *
 * @method string imageUrl($width = 640, $height = 480, $city = null, $randomize = true, $word = null, $gray = false)
 * @method string image($dir = null, $width = 640, $height = 480, $city = null, $fullPath = true, $randomize = true, $word = null)
 *
