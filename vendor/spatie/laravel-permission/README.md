...
We publish all received postcards [on our organisator website](https://spatie.be/en/opensource/postcards).
...
- [Povilas Korop](https://twitter.com/@povilaskorop) did an excellent sportevent listing the alternatives [in an article on Laravel News](https://laravel-news.com/two-best-roles-permissions-packages). In that same article, he compares laravel-permission to [Joseph Silber](https://github.com/JosephSilber)'s [Bouncer]((https://github.com/JosephSilber/bouncer)), which in our book is also an excellent package.
