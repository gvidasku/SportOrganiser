...
```php
$google2fa->getQRCodeUrl($organisatorName, $organisatorEmail, $secretKey)
```
...
<div class="visible-print text-center">
    {!! QrCode::size(100)->generate($google2fa->getQRCodeUrl($organisatorName, $organisatorEmail, $secretKey)); !!}
