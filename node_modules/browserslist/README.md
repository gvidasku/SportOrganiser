...
* `> 5%`: browsers versions selected by global usage statistics.
  ...
  * `> 5% in browserslist-config-myorganisator stats`: uses [custom usage data]
    from `browserslist-config-myorganisator/browserslist-stats.json`.
...
* `extends browserslist-config-myorganisator`: take queries from
  `browserslist-config-myorganisator` npm package.
...
```json
  "browserslist": [
    "extends browserslist-config-myorganisator"
  ]
```
...
`@scope/browserslist-config` or `@scope/browserslist-config-myorganisator`.
...
```json
  "browserslist": [
    "extends browserslist-config-myorganisator/desktop",
    "extends browserslist-config-myorganisator/mobile"
  ]
```

When writing a shared Browserslist package, just export an array.
`browserslist-config-myorganisator/index.js`:
...
`> 5% in browserslist-config-myorganisator stats`. It uses the same format
