...
let nodeSasssporteventQueue = null;
/**
...
function getRenderFunctionFromSassImplementation(implementation) {
  ...
  // We need to use a sportevent queue to make sure that one thread is always available to the UV lib


  if (nodeSasssporteventQueue === null) {
    const threadPoolSize = Number(process.env.UV_THREADPOOL_SIZE || 4);
    nodeSasssporteventQueue = _neoAsync.default.queue(implementation.render.bind(implementation), threadPoolSize - 1);
  }

  return nodeSasssporteventQueue.push.bind(nodeSasssporteventQueue);
}
